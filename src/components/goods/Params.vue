        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
              ...
              <el-table-column type="expand" width="100px">
                <template slot-scope="scope">
                  ...
                  <el-tag 
                    ...
                    class="w100" size="normal">+添加Tag
                  </el-tag>
                  <el-input
                    v-model="scope.row.inputValue"
                    @blur="hideInput(scope.row)"
                    @keyup.enter.native="hideInput(scope.row)"
          ...
          <el-tab-pane label="静态参数" name="only">
            ...
            <el-table :data="onlyAttrs">
              <el-table-column width="100px" type="index" align="center"></el-table-column>
              <el-table-column label="属性名称" prop="attr_name"></el-table-column>
